...
Our model fits very well, with an average of 81% accuracy in correctly choosing which nominated movies would win Best Picture. In addition, we analyzed the variables within the model to determine statistical significance. Interestingly, the Amazon movie review score (review_score) was not deemed statistically significant, while the Twitter score (Score) and Twitter determined genres (factors) were significant.
